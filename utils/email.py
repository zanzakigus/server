...
def send_random_password(correo: str, nombre: str, new_password: str):
  server = smtplib.SMTP("smtp.gmail.com", 587)
  server.starttls()
  server.login(EMAIL, PASSWORD)
          ...
          <tr>
            ...
            <td width="70%" align="center" valign="top">
              <div style="background-color:#FFFFFF;margin-top:50px;margin-bottom:50px;border-radius:10px;padding:10px">
                ...
                <div style="height:20px;width:10px"></div>
                <p style="font-size: 1.2rem">
                  Se ha solicitado la restarauci&oacute;n de su contrase&ntilde;a en la aplicaci&oacute;n de Resilience.
                </p>
                <p style="font-size: 1.2rem">
                  Su contrase&ntilde;a ha sido modificada, para ingresar a la aplicación favor de hacerlo con la siguiente contrase&ntilde;a.
                </p>
                <strong style="font-size: 1.6rem">
                  {new_password}
                </strong>
